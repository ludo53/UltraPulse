...
#[derive(Debug)]
pub struct UltraPulseProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UltraPulseProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UltraPulse processing");
    
    let mut processor = UltraPulseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UltraPulseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UltraPulseProcessor::new(false);
